...
class FoodTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        do {
            food = try context.fetch(fetchRequest)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let nameLabel = foods.value(forKey: "name") as? String {
            display = nameLabel }
        if let amountLabel = foods.value(forKey: "amount") as? String { display = display + " " + amountLabel
        }
        cell.textLabel?.text = foods.value(forKey: "name") as? String
        cell.detailTextLabel?.text = foods.value(forKey: "amount") as? String
